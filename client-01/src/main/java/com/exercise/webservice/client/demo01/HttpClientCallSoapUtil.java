...
public class HttpClientCallSoapUtil {
	...
	public static void main(String[] args) {
		String helloSoapXml = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:dem=\"http://demo01.server.webservice.exercise.com/\">" +
				"   <soapenv:Header/>" +
				"   <soapenv:Body>" +
				"      <dem:HelloWord>" +
				"         <arg0>办事处的</arg0>" +
		...
		String result = doPostSoap1_1(Constants.postUrl, helloSoapXml, "");
