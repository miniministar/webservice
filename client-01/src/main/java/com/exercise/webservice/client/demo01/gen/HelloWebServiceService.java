 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceService", targetNamespace = "http://demo01.server.webservice.exercise.com/", wsdlLocation = "http://localhost:8123/helloWord?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICESERVICE_QNAME = new QName("http://demo01.server.webservice.exercise.com/", "HelloWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8123/helloWord?wsdl");
    ...
    public HelloWebService getHelloWebServicePort() {
        return super.getPort(new QName("http://demo01.server.webservice.exercise.com/", "HelloWebServicePort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo01.server.webservice.exercise.com/", "HelloWebServicePort"), HelloWebService.class, features);
    }
