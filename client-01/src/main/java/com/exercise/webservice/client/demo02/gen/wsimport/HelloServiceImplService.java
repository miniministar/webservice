 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://demo02.server.webservice.exercise.com/", wsdlLocation = "http://localhost:8080/soap/ihelloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://demo02.server.webservice.exercise.com/", "HelloServiceImplService");
    ...
    public IhelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://demo02.server.webservice.exercise.com/", "HelloServiceImplPort"), IhelloService.class);
    }
    ...
    public IhelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo02.server.webservice.exercise.com/", "HelloServiceImplPort"), IhelloService.class, features);
    }
